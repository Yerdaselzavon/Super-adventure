...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateMonsters()
        {
            ...
            Monster snake = new Monster(MONSTER_ID_RAT, "Snake", 5, 3, 10, 3, 3);
        ...
        {
            Quest clearAlchemistsGarden = new Quest(QUEST_ID_CLEAR_ALCHEMIST_GARDEN, "Clear the alchemist's garden", "Kill rats in the alchemist's garden and bring back 3 rat tails. You will recieve a healing potion and 10 gold pieces", 20, 10);
        ...
        private static void PopulateLocations()
        {
            ...
            Location townSquare = new Location(LOCATION_ID_TOWN_SQUARE, "Town square", "You see a founain.");
